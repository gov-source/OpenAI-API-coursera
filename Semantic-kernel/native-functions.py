...
async def main():
    ...
    ## PLAY AROUND BY CHANGING CITY AND MONTH 
    context.variables["user_input"] = "I'm travelling to Kanpur, and it seems that it would happen in August. What would be the average temperature?"
