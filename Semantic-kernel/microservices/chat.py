...
async def main():
    ...
    ## ITaking input city as Lisbon, Porto, Braga, etc
    context.variables["user_input"] = "I'm travelling to Faro, and it seems that it would happen in March. What would be the average temperature?"
